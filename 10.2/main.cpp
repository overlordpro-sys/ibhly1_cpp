...
void loan() {
    ...
    cout << setw(5) << "Month" << setw(12) << "Principal" << setw(12) << "Interest" << setw(12) << "Payment" << setw(20) << "New Balance";
    do {
        cout << "\n";
        double interest = principal * monthly_rate;
        double balance = principal + interest - monthly_pay;
        cout << setw(5) << month << setw(12) << principal << setw(12) << interest << setw(12) << monthly_pay << setw(14) << std::fixed << std::setprecision(2) << balance;
        principal = balance;
        month++;
    }
