...
double sphereRadius(double radius)
{
...
int main() {
    ...
    cout << "Volume of radius 1.0 sphere ---> " << sphereRadius(1.0) << " units cubed" << endl;
    cout << "Volume of radius 2.25 sphere ---> " << sphereRadius(2.25) << " units cubed" << endl;
    cout << "Volume of radius 7.50 sphere ---> " << sphereRadius(7.50) << " units cubed" << endl;
