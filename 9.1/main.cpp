...
void promptUser(double &loanAmount, double &loanLength, double &interestRateLow,
                double &interestRateHigh);
double calculateMonthlyPayment(double loanAmount, double loanLength,
                               double interestRate);
int main() {
   ...
   while (interestRateLow <= interestRateHigh) {
      std::cout << "Interest Rate: " << interestRateLow << "\tMonthly payment: "
                << calculateMonthlyPayment(loanAmount, loanLength,
                                           interestRateLow)
                << std::endl;
